        ...
        $(document).ready(function() {
            var oTable = $('#payment_view').dataTable( {
                ...
                "sAjaxSource": '<?php echo base_url(); ?>index.php/payment/payment_details',
                        "bJQueryUI": true,
            ...
            $('#payment_type').change(function(){
                ...
                window.location.href = '<?php echo base_url(); ?>index.php/payment/payment_non_rental';
            }) ;
        } );
                        ...
                        <div class="panel-body">
                            <div class="adv-table">
                                <?php
                                    ...
                                    $this->table->set_heading('Payment Voucher No','Branch','Voucher Date','Payment Ledger','Invoice No','Vehicle RegNo','Brand','Payment Amount','description','Mode Of Payment','Status','Actions');
