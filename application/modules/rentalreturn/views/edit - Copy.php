        ...
        <script>
            ...
            function calculateNetAmount1(a)
            {
                ...
                var charges = +fuel_refil_charges + +traffic_fine + +additional_driver_charge + +chauffer_charges + +additional_insurance + +pai_charge + +misc_charges;
                var net = total_rent_charge+charges-deduction;
                ...
                {
                    var discount_percentage = document.getElementById("discount").value;
                    var discount_val = (total_rent_charge*discount_percentage)/100;
                    var discount = total_rent_charge - discount_val;
                }else{
                    var discount = document.getElementById("discount").value;
                }
                var net_amount_payable = parseFloat(Math.round((net - discount)*100)/100).toFixed(3);
                
                //alert(net_amount);
                document.getElementById("net_amount").value = net_amount_payable;
            }
        </script>
                            ...
                            <div class="col-md-6">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control form-control-inline input-medium"  size="16" type="text" value="<?php echo $rental_return->return_date; ?>" id="rental_return_date" placeholder="Select Date of Rental Return" name="rental_return_date" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" placeholder="Rate Per Day" id="rate_per_day" name="rate_per_day" value="<?php echo $rental_return->rate_per_day; ?>" onkeyup="calculateNetAmount();">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label col-lg-4" for="total_rent_charge">Total Rent Charge</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" placeholder="Rate Per Day" id="total_rent_charge" name="total_rent_charge" value="<?php echo $rental_return->total_rent_charges; ?>" onkeyup="calculateNetAmount1(this.value);" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
