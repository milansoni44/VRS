        ...
        $(document).ready(function() {
            var oTable = $('#receipt_view').dataTable( {
                ...
                "sAjaxSource": '<?php echo base_url(); ?>index.php/receipt/receipt_details',
                        "bJQueryUI": true,
            ...
            $('#receipt_type').change(function(){
                ...
                window.location.href = '<?php echo base_url(); ?>index.php/receipt/receipt_non_rental';
            }) ;
                        ...
                        <div class="panel-body">
                            <div class="adv-table">
                                <?php
                                    ...
                                    $this->table->set_heading('Receipt Voucher No','Branch','Voucher Date','Receipt Ledger','Invoice No','Vehicle RegNo','Brand','receipt_amount','description','Receipt Mode','Status','Actions');
