        ...
        <script type="text/javascript">
            $( document ).ready(function() {
                ...
                $('#receipt_form').submit(function(){
                    if($('#from_ac').val() == $('#to_ac').val()){
                        alert('Both account cannot be same.');
                        return false;
                    }else{
                        return true;
                    }
                ...
                $("#from_ac").change(function(){
                    ...
                    $("#description").val( 'Towards '+$("#from_ac option:selected").text());
                    var receipt_ledger = $("#from_ac option:selected").text();
                    var rental_id = $("#rental_id").val();
                    
                    if(receipt_ledger == 'DEPOSIT' || receipt_ledger == 'RENTAL CHARGES' || receipt_ledger == 'EXTRA KM'){
                            ...
                            if(rental_id == 0){
                                ...
                                $.ajax({
                                        ...
                                        try{
                                            ...
                                            else if(receipt_ledger == "EXTRA KM"){
                                                var amt = obj.km_extra_used*obj.extra_km;
                                                $('#receipt_amount').val(amt);
                                            }else{
                                                $('#receipt_amount').val(obj.rent_amount);
                                            }
                ...
                <div class="col-lg-7">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post" action="add" id="receipt_form">
