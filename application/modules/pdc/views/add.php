                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" action="add">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="date_of_issue" placeholder="Select Date of issue" value="<?php echo set_value('date_issue'); ?>" name="date_issue"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-3 control-label" for="date_in_cheque">Date in Cheque <span style="color:red;">*</span></label>
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="date_in_cheque" placeholder="Select Date in Cheque" value="<?php echo set_value('date_cheque'); ?>" name="date_cheque"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Vehicle No" id="vehicle_no" value="<?php echo set_value('vehicle_no'); ?>" name="vehicle_no">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="payment_to" placeholder="Select payment to date" value="<?php echo set_value('payment_to'); ?>" name="payment_to_date"/>
                                </div>
                            </div>
                            <div class="panel-body">
                                <p>
