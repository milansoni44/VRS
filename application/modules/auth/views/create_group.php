                            ...
                            <div class="col-md-6">
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-lg-4 col-sm-3 control-label"><?php echo lang('create_group_name_label', 'group_name');?></div>
                                        <div class="col-lg-8">
                                            <?php echo form_input($group_name);?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-4 col-sm-3 control-label"><?php echo lang('create_group_desc_label', 'description');?></div>
