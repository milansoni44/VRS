...
class Auth extends MX_Controller {
	...
	function create_user()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			{
                $ext1 = end(explode(".", $_FILES['user_image']['name']));
                $file_name = "user-".$rowcount.".".$ext1;
                $image_path = realpath(APPPATH."../assets/uploads/users/");
                $config = array(
				...
				{
					$data = array('user_image' => $this->upload->data());
                }
				else
				{
                    // echo '<pre>';    
			...
			$additional_data = array(
                ...
                'user_image' => $data['user_image']['file_name'],
			);
			// echo '<pre>';
		...
		else
		{
            ...
            $meta['page_title'] = 'VRS | Create User';
	...
	function edit_user($id)
	{
		...
		if (isset($_POST) && !empty($_POST))
		{
            ...
            {
                $data['user_image']['file_name'] = $this->input->post('edit_user_image');
            }    
