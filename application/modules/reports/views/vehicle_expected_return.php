        ...
        $(document).ready(function() {
            $('#vehicle_rented_list').dataTable({
                ...
                "sAjaxSource": '<?php echo base_url(); ?>index.php/reports/vehicle_expected_return_details?start_date=<?php echo $this->input->post('start_date'); ?>&end_date=<?php echo $this->input->post('end_date'); ?>&vehicle=<?php echo $this->input->post('vehicle'); ?>',
                        "bJQueryUI": true,
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post" action="vehicle_expected_return">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label col-lg-2" for="start_date">Vehicle expected return period<span style="color:red;">*</span></label>
                                    <div class="col-lg-2">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <span class="tools pull-right">
                                <a class="custom-button" href="<?php echo base_url(); ?>index.php/reports/vehicle_expected_return_for_period?start_date=<?php echo $this->input->post('start_date'); ?>&end_date=<?php echo $this->input->post('end_date'); ?>&vehicle=<?php echo $this->input->post('vehicle'); ?>"> Export</a>
                            </span>
                        </header>
                        <div class="panel-body">
                            <div class="adv-table">
