        ...
        $(document).ready(function() {
            var oTable = $('#payment_for_a_period').dataTable( {
                ...
                "sAjaxSource": '<?php echo base_url(); ?>index.php/reports/payment_details?start_date=<?php echo $this->input->post('start_date'); ?>&end_date=<?php echo $this->input->post('end_date'); ?>&rental_type=<?php echo $this->input->post('rental_type'); ?>',
                        "bJQueryUI": true,
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post" action="payment_period">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label col-lg-2" for="start_date">Payment date period<span style="color:red;">*</span></label>
                                    <div class="col-lg-2">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <span class="tools pull-right">
                                <a class="custom-button" href="<?php echo base_url(); ?>index.php/reports/payment_for_period?start_date=<?php echo $this->input->post('start_date'); ?>&end_date=<?php echo $this->input->post('end_date'); ?>&rental_type=<?php echo $this->input->post('rental_type'); ?>"> Export</a>
                            </span>
                        </header>
                        <div class="panel-body">
                            <div class="adv-table">
                                <?php
                                    $tmpl = array ( 'table_open'  => '<table id="payment_for_a_period" class="table table-bordered table-hover">' );
                                    $this->table->set_template($tmpl);
                                    $this->table->set_heading('Payment Voucher No','Voucher Date','Vehicle No','description','Payment Ledger','Payment Amount');
