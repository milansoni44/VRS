        ...
        $(document).ready(function() {
            var oTable = $('#transaction_detail').dataTable( {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url(); ?>index.php/transactions/transaction_details',
                        "bJQueryUI": true,
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <span class="tools pull-right">
                                <a class="custom-button" href="<?php echo base_url(); ?>index.php/transactions/export_transaction_detail"> Export</a>
                            </span>
                        </header>
                        <div class="panel-body">
                            <div class="adv-table" id="printable">
                                <?php
                                    ...
                                    $this->table->set_heading('Sno','Transaction No','Voucher Type','Voucher No','Ledger','Dr Amount','Cr Amount');
